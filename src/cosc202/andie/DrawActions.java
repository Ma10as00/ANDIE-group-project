    ...
    public class DrawRecAction extends ImageAction {
        ...
        public void actionPerformed(ActionEvent e) {
            try{
                ...
                int chooseOption = JOptionPane.showOptionDialog(null, choosePanel, "Colour Rectangle?", JOptionPane.OK_CANCEL_OPTION, JOptionPane.CANCEL_OPTION, null, null, chooseOption);
                if(chooseOption == JOptionPane.CANCEL_OPTION){
                    ...
                    if(colourBox.isSelected()) target.getImage().apply(new DrawRec(Andie.mouseSec, ColourActions.activeColour , chooseOption, enabled));
